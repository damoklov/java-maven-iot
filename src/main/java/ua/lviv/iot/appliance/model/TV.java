...
public class TV extends HomeAppliance {
    ...
    public TV(int powerConsumption, double repairPrice, double hoursInMonthUsage, String locationInHouse, String applianceName, boolean needsPowerFromSocket, Quality quality, int numChannelsAvailable) {
    ...
    public TV() {
        this(DEFAULT_POWER_CONSUMPTION, DEFAULT_USAGE, DEFAULT_REPAIR_PRICE, DEFAULT_LOCATION, DEFAULT_NAME, DEFAULT_SOCKET_STATE, DEFAULT_QUALITY, DEFAULT_CHANNELS);
    }
